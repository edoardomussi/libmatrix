...
int main() {
    ...
    printf("Benchmarking mmul_tpose (AVX2) on %zux%zu matrices...\n", N, N);
    ...
    printf("Iterations: %d | Avg time: %.4f seconds | Throughput: %.2f GFLOPS | Sanity sum: %f\n", ITERATIONS, avg_time, gflops, sum);
